...
! function(a) {
    ...
    var b, c = "function" == typeof define && define.amd,
        ...
        k = function() {
            var b = function(b) {
                ...
                F = function(a) {
                    var b = E(a);
                    return 0 === b ? !0 : m(a) || 1 !== b || a.innerHTML !== D ? h.all(a.childNodes, m) && "" === a.innerHTML ? !0 : !1 : !0
                },
                G = function(a) {
        ...
        l = function() {
            ...
            return {
                create: function(a, c, e, g) {
                    if (arguments.length) 2 === arguments.length && (e = a, g = c);
        ...
        m = {
            ...
            options: {
                ...
                shortcuts: !0,
                placeholder: 'Please write a response for this answer..',
                prettifyHtml: !0,
                iconPrefix: "fa fa-",
                codemirror: {
                    mode: "text/html",
        ...
        q = function() {
            ...
            this.stylePara = function(b, c) {
                ...
                if (j && j.style["line-height"]) g["line-height"] = j.style.lineHeight;
                else {
        ...
        r = function() {
            this.insertOrderedList = function() {
                ...
                var d = h.head(b),
                    e = h.last(b),
                    f = k.isList(d.previousSibling) && d.previousSibling,
                    g = k.isList(e.nextSibling) && e.nextSibling,
                    i = f || k.insertAfter(k.create(c || "UL"), e);
                return b = a.map(b, function(a) {
                    return k.isPurePara(a) ? k.replace(a, "LI") : a
                }), k.appendChildNodes(i, b), g && (k.appendChildNodes(i, h.from(g.childNodes)), k.remove(g)), b
        ...
        t = function() {
            this.tab = function(a, b) {
                ...
                for (var d, e = [], f = 0; b > f; f++) e.push("<td>" + k.blank + "</td>");
                d = e.join("");
        ...
        v = function(b) {
            ...
            this.createRange = function(a) {
                ...
                var b = l.create();
                return b ? b.isOnEditable() && c.current(b, a) : !1
            };
            var i = function(a) {
            ...
            for (var m = this, o = this.beforeCommand = function(a) {
                ...
                }, v = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], w = 0, x = v.length; x > w; w++) this[v[w]] = function(a) {
                return function(b, c) {
            ...
            for (var w = 1; 6 >= w; w++) this["formatH" + w] = function(a) {
                return function(b) {
            ...
            this.fontSize = function(b, d) {
                ...
                if (b) {
                    var c = h.find(h.from(b.childNodes), k.isText),
                        d = c.nodeValue.indexOf(k.ZERO_WIDTH_NBSP_CHAR); - 1 !== d && c.deleteData(d, 1), k.isEmpty(b) && k.remove(b), a.removeData(u)
                }
            }, this.lineHeight = function(a, b) {
                o(a), c.stylePara(l.create(), {
                    lineHeight: b
                }), p(a)
        ...
        w = function() {
            this.update = function(b, c) {
                ...
                if (j.length) {
                    var k = c["font-family"];
                    if (k) {
                        for (var l = k.split(","), m = 0, n = l.length; n > m && (k = l[m].replace(/[\'\"]/g, "").replace(/\s+$/, "").replace(/^\s+/, ""), !f.isFontInstalled(k)); m++);
    ...
    var D = function(a) {
                ...
                if (!c || !c.items || !c.items.length) {
                    ...
                    return a.invoke("editor.saveNode", e), a.invoke("editor.saveRange", e), e.html(""), void setTimeout(function() {
                        ...
                        if (b.length && -1 !== b[0].src.indexOf("data:")) {
                            for (var c = b[0].src, f = atob(c.split(",")[1]), g = new Uint8Array(f.length), h = 0; h < f.length; h++) g[h] = f.charCodeAt(h);
                            var i = new Blob([g], {
                                type: "image/png"
                            });
                            i.name = "clipboard.png", a.invoke("editor.restoreNode", e), a.invoke("editor.restoreRange", e), a.insertImages(d, [i]), a.invoke("editor.afterCommand", e)
                        } else {
                            var j = e.html();
                            a.invoke("editor.restoreNode", e), a.invoke("editor.restoreRange", e), a.invoke("editor.focus", e);
                            try {
                                a.invoke("editor.pasteHTML", e, j)
                            } catch (k) {
                                a.invoke("editor.insertText", e, j)
                            }
                        }
                    }, 0)
                }
                var g = h.head(c.items),
                    i = "file" === g.kind && -1 !== g.type.indexOf("image/");
                i && a.insertImages(d, [g.getAsFile()]), a.invoke("editor.afterCommand", e)
            }
        },
        G = function(b) {
            var c = function(a, b) {
                ...
                d = function(a, b) {
                    a.on("keypress", function(a) {
                        a.keyCode === o.code.ENTER && b.trigger("click")
                    })
                };
            this.showLinkDialog = function(b, e, f) {
                return a.Deferred(function(a) {
                    ...
                    b.one("shown.bs.modal", function() {
                        ...
                        }), f.url || (f.url = f.text, c(i, f.text)), h.on("input", function() {
                            c(i, g.val() && h.val()), f.text || g.val(h.val())
                        }).val(f.url).trigger("focus").trigger("select"), d(h, i), d(g, i), j.prop("checked", f.newWindow), i.one("click", function(c) {
                            c.preventDefault(), a.resolve({
                                range: f.range,
                                url: h.val(),
                                text: g.val(),
                                newWindow: j.is(":checked")
                            }), b.modal("hide")
                        })
        ...
        J = function() {
                ...
                q = function(c) {
                    ...
                    if (e.length) {
                        var f, g = e.attr("data-event"),
                            i = e.attr("data-value"),
                            l = e.attr("data-hide"),
                            m = k.makeLayoutInfo(c.target);
                        if (-1 !== a.inArray(g, ["resize", "floatMe", "removeMedia", "imageShape"])) {
                            var n = m.handle().find(".note-control-selection");
                            f = a(n.data("target"))
                        }
                        if (l && e.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[g])) a.summernote.pluginEvents[g](c, b.editor, m, i);
                        else if (b.editor[g]) {
                            var o = m.editable();
                            o.focus(), b.editor[g](o, i, f), c.preventDefault()
                        } else d[g] && (d[g].call(this, m), c.preventDefault());
                        if (-1 !== a.inArray(g, ["backColor", "foreColor"])) {
                            var p = m.editor().data("options", p),
                                q = p.airMode ? b.popover : b.toolbar;
                            q.updateRecentColor(h.head(e), g, i)
                        }
                        j(c)
                    }
                },
            ...
            this.bindKeyMap = function(c, e) {
                ...
                c.shortcuts && this.bindKeyMap(a, c.keyMap[f.isMac ? "mac" : "pc"]), a.editable().on("mousedown", e), a.editable().on("keyup mouseup", i), a.editable().on("scroll blur", l), b.clipboard.attach(a, c), b.handle.attach(a, c), a.popover().on("click", q), a.popover().on("mousedown", m), b.dragAndDrop.attach(a, c), c.airMode || (a.toolbar().on("click", q), a.toolbar().on("mousedown", m), b.statusbar.attach(a, c));
                var d = c.airMode ? a.popover() : a.toolbar(),
                ...
                g.css({
                    ...
                    s(a, c)
                }), a.editor().data("options", c), f.isMSIE || setTimeout(function() {
                    document.execCommand("styleWithCSS", 0, c.styleWithSpan)
                }, 0);
                var j = new p(a.editable());
                a.editable().data("NoteHistory", j), a.editable().data("callbacks", {
                    onInit: c.onInit,
                    onFocus: c.onFocus,
                    onBlur: c.onBlur,
                    ...
                    onEnter: c.onEnter,
                    onPaste: c.onPaste,
                    onBeforeCommand: c.onBeforeCommand,
                    onChange: c.onChange,
                    onImageUpload: c.onImageUpload,
                    onImageUploadError: c.onImageUploadError,
                    onMediaDelete: c.onMediaDelete
                }), k.isTextarea(h.head(a.holder())) && a.holder().closest("form").submit(function() {
                    a.holder().val(a.holder().code())
                })
                ...
                for (var l = 0, m = a.summernote.plugins.length; m > l; l++) a.isFunction(a.summernote.plugins[l].init) && a.summernote.plugins[l].init(b)
        ...
        K = function() {
            var b = function(a, b) {
                    ...
                    fontname: function(a, c) {
                        var d = [],
                            e = c.fontNames.reduce(function(a, b) {
                                return f.isFontInstalled(b) || -1 !== c.fontNamesIgnoreCheck.indexOf(b) ? (d.push(b), a + '<li><a data-event="fontName" href="#" data-value="' + b + '" style="font-family:\'' + b + '\'"><i class="' + c.iconPrefix + 'check"></i> ' + b + "</a></li>") : a
                            }, ""),
                ...
                t = {
                    ...
                    help: function(a, b) {
                        var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (f.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.7</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
            ...
            this.createLayoutByAirMode = function(b, c) {
                ...
                var k = document.body,
                    l = a(i(d, c));
                l.addClass("note-air-layout"), l.attr("id", "note-popover-" + h), l.appendTo(k), x(l, e), y(l, c);
                var m = a(j());
                m.addClass("note-air-layout"), m.attr("id", "note-handle-" + h), m.appendTo(k);
                var n = a(u(d, c));
                ...
                c.width && e.width(c.width), c.height > 0 && a('<div class="note-statusbar">' + (c.disableResizeEditor ? "" : v()) + "</div>").prependTo(e);
                var g = !b.is(":disabled"),
                    l = a('<div class="note-editable" contentEditable="' + g + '"></div>').prependTo(e);
                c.height && l.height(c.height), c.direction && l.attr("dir", c.direction);
                var m = b.attr("placeholder") || c.placeholder;
                m && l.attr("data-placeholder", m), l.html(k.html(b)), a('<textarea class="note-codable"></textarea>').prependTo(e);
                ...
                n.prependTo(e);
                var B = c.keyMap[f.isMac ? "mac" : "pc"];
                y(n, c), x(n, B, "bottom");
                var C = a(i(d, c)).prependTo(e);
                y(C, c), x(C, B), a(j()).prependTo(e);
                var D = a(u(d, c)).prependTo(e);
    ...
    a.extend(a.summernote, {
        ...
        summernote: function() {
            ...
            if (e = a.extend({}, a.summernote.options, e), e.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote.lang[e.lang]), !c && d)
